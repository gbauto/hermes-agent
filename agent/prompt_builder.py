...
KANBAN_GUIDANCE = (
    ...
    "every 10–15 minutes during long subprocesses (training, encoding, crawling), "
    "and make the note human-readable with concrete progress (e.g. files changed, "
    "tests running, rows processed, current blocker). Skip heartbeats for short "
    "tasks. **If your task may run longer than 1 hour, you MUST call "
    "`kanban_heartbeat` at least once an hour** — the dispatcher "
