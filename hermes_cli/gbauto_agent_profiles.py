...
The source of truth is the neutral ``agent_profile_*`` schema. Repo-generated
TypeScript catalogs can enrich the UI, but profile/team membership should come
from Supabase when the dashboard is online.
"""
...
from hermes_cli.gbauto_chat import ALLOWED_TENANTS, _run_cli, _sql_literal
